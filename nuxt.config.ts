...
export default defineNuxtConfig({
  ...
  css: ['~/assets/css/main.css', '~/assets/css/grid.css', '~/assets/css/component.css', '~/assets/css/style.css'],
  runtimeConfig: {
  ...
  modules: ['@nuxt/eslint', '@pinia/nuxt', 'pinia-plugin-persistedstate/nuxt', '@vue-macros/nuxt'],
})
