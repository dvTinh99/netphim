  ...
  <header class="bg-[#09080b] py-3 px-4 sticky top-0 z-50">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      <div class="flex items-center">
        ...
        <nav class="hidden md:flex space-x-4 lg:space-x-6">
          ...
          <div class="relative group">
            <NuxtLink
              to="/kho-phim"
              class="text-white hover:text-[#dd003f] text-sm flex items-center gap-1"
            >
              Thể loại
              <ChevronDown
            ...
            <!-- Submenu -->
            <div
              class="absolute left-0 top-full mt-1 bg-[#0d0d0d] border border-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 w-[800px] p-4"
            >
              ...
              <div class="mt-4 pt-3 border-t border-gray-800">
                <NuxtLink
                  to="/kho-phim"
                  class="text-[#dd003f] hover:underline text-sm flex items-center justify-center gap-1"
                >
                  Xem tất cả phim
            ...
            >
              <div class="grid grid-cols-5">
                <div v-for="column in 5" :key="`column-${column}`">
                  <ul class="">
                    <li
                      v-for="item in getCountryItems(column)"
                      :key="`submenu-${item}`"
                    >
                      <NuxtLink
                        :to="`/kho-phim/${item.slug}`"
          ...
          <NuxtLink
            to="/phim-dien-anh"
            class="text-white hover:text-[#dd003f] text-sm"
          >
            Phim lẻ
          </NuxtLink>
          <NuxtLink
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          class="bg-[#dd003f] hover:bg-[#dd003f]/80 text-white rounded-md px-4 py-1 text-sm"
        >
          Đăng nhập
        </button>
      </div>
    ...
    <div v-if="showMobileSearch" class="mt-3 px-4 py-2 md:hidden">
      <div class="relative">
        <input
          ...
          <div>
            ...
            <div v-if="showMobileSubmenu" class="bg-[#1a1a1a] py-2">
              ...
              <div class="px-8 py-2 border-t border-gray-800 mt-2">
                <NuxtLink
                  to="/kho-phim"
                  class="text-[#dd003f] hover:underline text-sm flex items-center gap-1"
                >
                  Xem tất cả phim
                  <ArrowRight class="w-3 h-3" />
                </NuxtLink>
...
import { Search, X, ChevronDown, ArrowRight, Menu, Film } from 'lucide-vue-next'
