  ...
  <div class="min-h-screen bg-[#06121e] text-white">
      ...
      <div class="container mx-auto flex items-center justify-between">
        <div class="flex items-center">
          ...
          <nav class="hidden md:flex space-x-6">
            ...
            <NuxtLink to="/phim-dien-anh" class="text-white hover:text-[#dd003f]">
              Phim điện ảnh
            </NuxtLink>
        ...
        <button class="bg-[#dd003f] hover:bg-[#dd003f]/80 text-white rounded-md px-4 py-1">
          Đăng nhập
        </button>
      </div>
    </header>
    ...
    <div class="relative h-[400px] mb-8">
      ...
      <div class="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-16">
        ...
        <p class="text-xl mb-6 text-white">HỌC KỲ SINH TỬ</p>
        <button class="bg-white text-black hover:bg-gray-200 px-6 py-2 rounded-md w-max font-medium">
          Đăng ký ngay
        </button>
      </div>
    </div>
    ...
    <section class="container mx-auto px-4 mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
        <div v-for="i in 3" :key="`hot-${i}`" class="relative group cursor-pointer">
          <img 
    ...
    <!-- Promotion Banner -->
    <section class="container mx-auto px-4 mb-8">
      <div class="bg-gradient-to-r from-purple-800 to-purple-500 rounded-lg p-4 relative overflow-hidden">
        <div class="flex items-center justify-between">
          <div class="z-10">
            <h2 class="text-2xl font-bold mb-2">TẶNG THÊM 3 THÁNG</h2>
            <p class="text-lg">KHI MUA GÓI 6 THÁNG VỚI 3 THÁNG</p>
            <button class="bg-white text-purple-800 px-4 py-1 rounded mt-2 font-medium">MUA NGAY</button>
          </div>
    ...
    <!-- Top 5 New Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Top 5 phim mới hay</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`top-${i}`" class="relative group cursor-pointer">
          <div class="absolute top-0 left-0 w-8 h-8 bg-[#dd003f] text-white flex items-center justify-center font-bold z-10">
            {{ i }}
          </div>
          <img 
    ...
    <!-- Thai Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Thái đặc sắc</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`thai-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
            :alt="`Thai Movie ${i}`" 
            class="w-full h-[250px] object-cover rounded-md"
    ...
    <!-- Crime Documentary -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Tư liệu Hình sự</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`crime-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
    ...
    <!-- Mystery Comedy -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Hài huyền bí</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`mystery-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
    ...
    <!-- Korean Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Hàn Quốc</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`korean-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
            :alt="`Korean Movie ${i}`" 
            class="w-full h-[250px] object-cover rounded-md"
    ...
    <!-- Anime -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Anime</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`anime-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
            :alt="`Anime ${i}`" 
            class="w-full h-[250px] object-cover rounded-md"
    ...
    <!-- Sci-Fi Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Khoa học viễn tưởng</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`scifi-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
            :alt="`Sci-Fi Movie ${i}`" 
            class="w-full h-[250px] object-cover rounded-md"
    ...
    <!-- Horror Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim Kinh dị</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`horror-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
            :alt="`Horror Movie ${i}`" 
            class="w-full h-[250px] object-cover rounded-md"
    ...
    <!-- Top Special Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">TOP PHIM ĐẶC SẮC</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-for="i in 3" :key="`special-${i}`" class="relative group cursor-pointer">
          <div class="absolute top-0 left-0 w-8 h-8 bg-[#dd003f] text-white flex items-center justify-center font-bold z-10">
            {{ i }}
          </div>
          <img 
    ...
    <!-- The Deal Banner -->
    <section class="container mx-auto px-4 mb-8">
      <div class="relative h-[150px] rounded-lg overflow-hidden">
        <img 
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center px-8">
          <div>
            ...
            <p class="text-lg mb-4">BUÔN BÁN BẢN ĐỀ</p>
            <p class="text-sm mb-2">ĐÃ CÓ TRỌN BỘ 8 TẬP</p>
            <button class="bg-[#dd003f] text-white px-4 py-1 rounded">XEM NGAY</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Movie Categories -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Khám phá</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-for="(category, index) in ['Phim Chiếu rạp', 'Phim Cổ trang', 'Phim Hành động']" :key="`category-${index}`" class="relative group cursor-pointer">
          <img 
    ...
    <!-- More Movies -->
    <section class="container mx-auto px-4 mb-8">
      <h2 class="text-xl font-bold mb-4">Phim đặc sắc</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div v-for="i in 5" :key="`more-${i}`" class="relative group cursor-pointer">
          <img 
            :src="`/placeholder.svg?height=250&width=180`" 
            :alt="`More Movie ${i}`" 
            class="w-full h-[250px] object-cover rounded-md"
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p class="text-sm text-gray-400 mb-4">
                Moon Play là dịch vụ được cung cấp bởi Công ty Cổ Phần Moon Play, thành viên của Công ty Cổ Phần Giải
                Trí và Giáo Dục Moon
              </p>
            </div>
